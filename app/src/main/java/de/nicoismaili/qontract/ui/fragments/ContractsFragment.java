...
public class ContractsFragment extends Fragment
     ...
     * Initializes {@link #navController} and {@link #viewModel}, creates Contract RecyclerView
     * and sets Listeners on certain views.
     *
    ...
    public void onViewCreated(@NonNull View view, Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(
                this::onAddContractClick);
    }


    /**
     * If {@link #actionMode} is active, add the contract to the selection, otherwise
     * navigates to {@link EditContractFragment} with isNewContract to false.
     *
