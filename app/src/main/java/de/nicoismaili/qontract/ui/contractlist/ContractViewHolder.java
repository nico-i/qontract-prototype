...
class ContractViewHolder extends RecyclerView.ViewHolder
    ...
    /**
     * Creates a new {@link ContractViewHolder} object.
     *
     * @param parent                  The parent of this {@link androidx.recyclerview.widget.RecyclerView.ViewHolder}
     * @param onContractClickListener Interface to handle onClick Events
     * @return The new {@link ContractViewHolder} object
     */
    ...
    /**
     * Binds the Views contain in this ViewHolder's layout to a given Contract.
     *
     * @param contract The contract that is to be held by this View
     */
    public void bind(Contract contract) {
        // Gets first- and lastname and rebuilds String to contain or consist of initials if names are too long
        String firstName =
