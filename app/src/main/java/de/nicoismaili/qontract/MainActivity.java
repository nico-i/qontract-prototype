...
public class MainActivity extends AppCompatActivity {
    ...
    /**
     * This hook is called whenever an item in the
     * options menu is selected. Overriding this
     * method is necessary to make the AppBar dependent
     * on the navigation.
     *
     ...
     * activity hierarchy from the action bar. Overriding this
     * method is also necessary to make the AppBar dependent
     * on the navigation.
     *
