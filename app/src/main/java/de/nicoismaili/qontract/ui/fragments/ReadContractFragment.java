...
public class ReadContractFragment extends Fragment {
  ...
  /**
   * Called to have the fragment instantiate / inflate its user interface view. This method is
   * called between {@link #onCreate(Bundle)} and {@link #onViewCreated(View, Bundle)}.
   *
   ...
   * but before any saved state has been restored in to the view. Initializes {@link
   * android.view.View.OnClickListener} for the "back to contract" button.
   *
