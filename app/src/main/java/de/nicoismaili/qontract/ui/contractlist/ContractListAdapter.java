...
/**
 * A {@link ListAdapter} subclass for presenting
 * contracts in a RecyclerView, including computing diffs between
 * contract lists on a background thread.
 */
public class ContractListAdapter extends ListAdapter<Contract, ContractViewHolder> {
    ...
    /**
     * Interface to implement normal and long
     * ClickEvents on a Contract in the {@link androidx.recyclerview.widget.RecyclerView}.
     */
    ...
    /**
     * Anonymous {@link ItemCallback} subclass to implement the callbacks that are triggered when the LiveData changes.
     */
